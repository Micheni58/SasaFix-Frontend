...
import { Mail, Phone, CheckCircle2, Clock3, AlertCircle, MessageSquare, RotateCcw, Flag, Pause } from "lucide-react";
import { Link } from "react-router-dom";

function InProgressJobDetails() {
    // Sample job data
    const job = {
        id: "00003",
        ...
        date: "Jan 15, 2026",
        time: "09:00 AM",
        location: "Kilimani, Nairobi - House 45, Oak Street",
        duration: "4 hours",
        status: "In Progress",
        client: {
            name: "Mary Okonkwo",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1">
                    <div className="sticky top-6 bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-4">
                        ...
                        <button className="w-full flex items-center justify-center gap-2 border-2 border-orange-200 text-orange-600 font-semibold py-2 px-2 rounded-lg hover:bg-orange-50 transition-colors">
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-200 bg-[#fdffe9] rounded-2xl p-4">
                            ...
                            <ul className="space-y-2 text-sm text-gray-700">
                                <li className="flex gap-2">
                                    ...
                                    <span>Keep client updated on progress</span>
                                </li>
                                <li className="flex gap-2">
                                    <span className="text-[#056db3] font-bold">•</span>
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
                    <div className="w-full max-w-lg rounded-3xl bg-white p-6 shadow-2xl">
                        ...
                        <p className="text-sm text-gray-600 mb-6">
                            Are you sure you want to mark this job as completed? Please ensure all work has been finished and the client is satisfied before confirming.
                        </p>
                        <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
                            ...
                            <button onClick={confirmModal} className="w-full sm:w-auto rounded-lg bg-green-600 px-4 py-2 text-sm font-semibold text-white hover:bg-green-700 transition-colors">
                                Yes, Mark Completed
                            </button>
                        </div>
                    </div>
